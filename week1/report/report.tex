...
A rough estimate would be 4-5\% effective samples, it varies per run, but effective samples happens approximately every 20 samples or so.
...
not get that close to $0$. Figure \ref{fig:q1_7d} show the resulting
